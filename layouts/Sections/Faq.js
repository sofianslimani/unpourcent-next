...
const Faq = () => {
	...
	const renderFaqItem = (item, index) => (
		<div
			className={'faq-container-bottom-wrapper-content-item'}
			key={index}
		>
			<div
				className={'faq-container-bottom-wrapper-content-item-header'}
			>
				<div
					className={
						'faq-container-bottom-wrapper-content-item-header-title'
					}
				>
					<button
						className={
				...
				<div
					className={
						'faq-container-bottom-wrapper-content-item-header-icon'
					}
				>
					{index === faqIndex ? (
